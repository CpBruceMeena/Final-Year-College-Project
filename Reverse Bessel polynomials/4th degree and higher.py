...
# The time required for training is ---88.95321393013 seconds
# [-1.01436036  0.07227494  0.11192912  0.04795907 -0.00523938] [0.96470215]
# The r2 score on the training data is  0.5388021209458876
...
def Tx(a):
    ...
    Tx_values[0] = 1
    Tx_values[1] = a+1
    Tx_values[2] = 1*(a**2) + 3*a + 3
    Tx_values[3] = 1*(a**3) + 6*a**2 + 15*a + 15
    Tx_values[4] = 1*(a**4) + 10*a**3 + 45*a**2 + 105*a + 105
...
plt.title("using 4th degree Reverse Bessel polynomial")
