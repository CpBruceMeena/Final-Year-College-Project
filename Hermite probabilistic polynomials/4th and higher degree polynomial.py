...
# The time required for training is ---72.30012440681458 seconds
# [-1.15739241  0.00136954 -0.61861353 -0.19450472 -0.1040752 ] [1.41120732]
# <class 'numpy.ndarray'>
# The r2 score on the training data is  0.5573498946567704
...
def Tx(a):
    ...
    Tx_values[2] = (a**2) - 1
    Tx_values[3] = a**3 - 3*a
    Tx_values[4] = a**4 - 6*(a**2) + 3
    # Tx_values[5] = a**5 - 10*a**3 + 15*a
    return Tx_values
...
plt.title("using 4th degree hermite probabilistic polynomial")
