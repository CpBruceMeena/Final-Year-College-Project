...
# The time required for training is ---79.13728046417236 seconds
# [-0.63724726  0.35418512 -0.05068254 -0.0577807   0.03918709] [1.14348007]
# <class 'numpy.ndarray'>
# The r2 score on the training data is  0.5706353725165237
...
def Tx(a):
    ...
    Tx_values[1] = a
    Tx_values[2] = 2*(a**2) - 1
    Tx_values[3] = 4*(a**3) - 3*a
    Tx_values[4] = 8*(a**4) - 8*(a**2) + 1
    return Tx_values
...
plt.title("using 4th degree chebyshev polynomial")
